...
export default function SideBar({setoutSideNumber}) {
    ...
    return (
        <div class="flex flex-col w-1/6 h-screen px-4 py-8 bg-white border-r dark:bg-gray-800 dark:border-gray-600">
        ...
        <div class="flex flex-col justify-between flex-1 mt-6">
            <nav>
                <a class="flex items-center px-4 py-2 text-gray-700 bg-gray-200 rounded-md dark:bg-gray-700 dark:text-gray-200" href="#">
                    ...
                    <span onClick={() => {setoutSideNumber(3); setnumber(3)}} class="mx-4 text-sm">Classic Rope</span>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span onClick={() => {setoutSideNumber(15); setnumber(15)}} class="mx-4 text-sm">Rattler Rope</span>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span onClick={() => {setoutSideNumber(23); setnumber(23)}} class="mx-4 text-sm">Classic Equine</span>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span onClick={() => {setoutSideNumber(139); setnumber(139)}} class="mx-4 text-sm">Train Win Compete</span>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span  onClick={() => {setoutSideNumber(150); setnumber(150)}} class="mx-4 text-sm">Martin Saddlery</span>
                </a>
                ...
                <a class="flex items-center px-4 py-2 mt-5 text-gray-600 transition-colors duration-200 transform rounded-md dark:text-gray-400 hover:bg-gray-200 dark:hover:bg-gray-700 dark:hover:text-gray-200 hover:text-gray-700" href="#">
                    ...
                    <span onClick={() => {setoutSideNumber(259); setnumber(259)}} class="mx-4 text-sm">Cashel</span>
                </a>
